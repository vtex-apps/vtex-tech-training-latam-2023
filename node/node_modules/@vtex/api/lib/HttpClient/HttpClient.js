    ...
    constructor(opts) {
        ...
        this.request = async (config) => {
            ...
            config.tracing = this.tracer ? {
                rootSpan: (_a = config.tracing) === null || _a === void 0 ? void 0 : _a.rootSpan,
                tracer: this.tracer,
            } : undefined;
        ...
        const { baseURL, authToken, authType, memoryCache, diskCache, locale, name, metrics, product, serverTiming, recorder, userAgent, timeout = DEFAULT_TIMEOUT_MS, segmentToken, sessionToken, retries, concurrency, headers: defaultHeaders, host, params, operationId, tenant, binding, verbose, cancellation, exponentialTimeoutCoefficient, initialBackoffDelay, exponentialBackoffCoefficient, httpsAgent, tracer, } = opts;
