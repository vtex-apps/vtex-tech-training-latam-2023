export declare type FetchResult<V> = {
    value: V;
    maxAge?: number;
};
export declare type DiskStats = {
    hits: number;
    total: number;
    name: string;
};
export declare type LRUStats = {
    itemCount: number;
    length: number;
...
export declare type MultilayerStats = {
    hitRate: number | undefined;
    hits: number;
    total: number;
    name: string;
};
export declare type LRUDiskCacheOptions = {
    /**
