...
export declare class MessagesGraphQL extends AppGraphQLClient {
    ...
    translateV2(args: TranslateInput): Promise<string[]>;
    translate(args: TranslateInput): Promise<string[]>;
    translateWithDependencies(args: TranslateWithDependenciesInput): Promise<string[]>;
    saveV2(args: SaveInput): Promise<boolean>;
}
