...
export declare class PaymentProvider extends ExternalClient {
    ...
    callback: (transactionId: string, paymentId: string, callback: AuthorizationCallback) => Promise<unknown>;
    inbound: <TRequest, TResponse>(transactionId: string, paymentId: string, action: string, payload: TRequest) => Promise<TResponse>;
}
