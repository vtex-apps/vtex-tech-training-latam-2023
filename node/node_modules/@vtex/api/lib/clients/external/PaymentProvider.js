...
class PaymentProvider extends ExternalClient_1.ExternalClient {
    constructor(context, options) {
        ...
        this.callback = (transactionId, paymentId, callback) => this.http.post(routes.callback(transactionId, paymentId), callback, {
            metric: 'gateway-callback',
        });
        this.inbound = (transactionId, paymentId, action, payload) => this.http.post(routes.inbound(transactionId, paymentId, action), payload, {
