...
class Assets extends InfraClient_1.InfraClient {
    constructor(context, options) {
        ...
        this.getAppJSONByAccount = (app, path, nullIfNotFound) => {
            const locator = utils_1.parseAppId(app);
        ...
        this.getAppJSONByVendor = (app, path, nullIfNotFound) => {
            const locator = utils_1.parseAppId(app);
    ...
    async getJSON(appId, file, nullIfNotFound) {
        const locator = utils_1.parseAppId(appId);
        const linked = !!locator.build;
        if (linked) {
            return this.getAppJSONByAccount(appId, file, nullIfNotFound);
        }
