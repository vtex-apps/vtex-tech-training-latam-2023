...
const initTracer_1 = require("../tracing/initTracer");
...
const createAppEventHandlers = ({ config: { events, clients } }) => {
    if (events && clients) {
        return Object.keys(events).reduce((acc, eventId) => {
            acc[eventId] = events_1.createEventHandler(clients, eventId, events[eventId]);
            return acc;
        }, {});
    }
    return null;
...
exports.startWorker = (serviceJSON) => {
    ...
    const tracer = initTracer_1.initServiceTracer();
